<div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom width-80">
    <a href="{{ route('home') }}" class="d-flex align-items-center text-dark text-decoration-none">
      ...
      <span class="fs-4">Name_Company</span>
    </a>
    ...
    <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
      ...
      <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('contact-all') }}">Contact-All</a>
    </nav>
</div>